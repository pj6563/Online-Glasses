...
<body>
	...
	String c009 = request.getParameter("009");
	
	
	int t009 = Integer.parseInt(c009);
	...
	//리퀘스트로 위에 넘긴 Get방식의 파라미터명을 써서 내용을 받는다.
		...
		try{
			...
			String sql ="update board set author=?,title=?,content=?,date=?,hit=?,priority=?,bord_name=? where count=? ";
