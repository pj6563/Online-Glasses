				...
				if (number != null || number != "0" ) {
					...
					try{
						...
						%>
						 	...
						 	<form action = "rewrite.jsp" accept-charset="utf-8" name = "coment" method = "get">
									<tr>
										<th >제목
										<td >
											&nbsp;&nbsp;<%=title%>
									...
									<tr>
										...
										<td class="B">
											<a href="javascript:history.back()">
												<a href="javascript:history.back()" class="writeB" type="submit">목록으로</a>
											</a>
					...
					<tr>
						<th >제목
						<td >
							<input name="title" type="text" 	maxlength="20" value="">
						</td>
					</tr>
					<tr>
						<th>내용
						<td >
							<textarea name="contnet" rows="10" cols="100%" ></textarea>
						</td>
					</tr>
					<tr>
						<th></th>
