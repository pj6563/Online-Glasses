...
String sql = ("select * from scalership");                        // sql 쿼리
...
while(rs.next()){ 
	...
	String imgage = rs.getString("imgage");
...
%>
	...
	<table style="border:0.5px solid blue;"><!-- 장학내용 출력 -->
			<tr>
				<td style="border:0.5px solid blue;"><%=name%>
				<td style="border:0.5px solid blue;"><%=money%>
				<td style="border:0.5px solid blue;"><%=period%>
				<td style="border:0.5px solid blue;">?
				<td style="border:0.5px solid blue;"><%=agency%>
				<td style="border:0.5px solid blue;"><a href="<%=link%>">이동</a></td>
			</tr>
		</table>
