...
%>
 	...
 	<table style="border:0.5px solid blue;">
			<tr>
				<th style="border:0.5px solid blue;">번호
				<th style="border:0.5px solid blue;">제목
				<th style="border:0.5px solid blue;">작성자
				<th style="border:0.5px solid blue;">작성일시
				<th style="border:0.5px solid blue;">조회수
			</tr>
			<tr>
				<td style="border:0.5px solid blue;">
				<td style="border:0.5px solid blue;"><%=title%>
				<td style="border:0.5px solid blue;"><%=author%>
				<td style="border:0.5px solid blue;"><%=date%>
				<td style="border:0.5px solid blue;"><%=hit%>	
			</tr>
	</table>
	<a href="#"><button>등록</a> 
	</form>
